...
# translation
SOURCES = treemap.py ui_treemap.py __init__.py treemapdialog.py
#TRANSLATIONS = i18n/treemap_en.ts
TRANSLATIONS = 
...
PY_FILES = treemap.py treemapdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_treemap.py
